...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "exp2_1_5", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": '/home/cgv841/wzm/FYP/AGAPG/aerial_gym/param_saved/track_simpleVer8.pth',
...
if __name__ == "__main__":
    args = get_args()
    run_name = f"tmp_{args.task}__{args.experiment_name}__{args.seed}__{get_time()}"
    if args.tmp:
