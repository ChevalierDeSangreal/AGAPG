...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "exp3_6__len_sample_50", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": 'track_groundVer9__e4__schedule__2000epoch.pth',
