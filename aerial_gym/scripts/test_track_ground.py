...
def get_args():
	custom_parameters = [
		...
		{"name": "--param_load_path_track_simple", "type":str, "default": '/home/cgv841/wzm/FYP/AGAPG/aerial_gym/param_saved/track_groundVer3.pth',
...
if __name__ == "__main__":
	...
	dynamic.to(device)
	model = TrackGroundModelVer2().to(device)
