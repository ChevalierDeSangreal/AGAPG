...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "main_test_succ__thr1.5", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--threshold", "type":float, "default": 1.5, "help": "the radius to judge in last 100 step"},
