...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "exp4.1", "help": "Name of the experiment to run or load."},
        ...
        # train setting
        {"name": "--learning_rate", "type":float, "default": 5e-6,
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": '/home/cgv841/wzm/FYP/AGAPG/aerial_gym/param_saved/track_groundVer5.pth',
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epoch):
        ...
        print(f"Epoch {epoch}: loss = {loss}, loss2 = {loss2}, hoz_dis = {hoz_dis}")
