...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "exp2_1_2", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--num_epoch", "type":int, "default": 10000,
            "help": "num of epoch"},
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": '/home/cgv841/wzm/FYP/AGAPG/aerial_gym/param_saved/track_simpleVer5.pth',
