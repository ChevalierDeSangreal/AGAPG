...
from aerial_gym.models import TrackSimpleModelVer3
from aerial_gym.envs import LearntDynamics
# os.path.basename(__file__).rstrip(".py")
def get_args():
    custom_parameters = [
        {"name": "--task", "type": str, "default": "track_groundVer4", "help": "The name of the task."},
        {"name": "--experiment_name", "type": str, "default": "exp2_2__big", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": 'track_simpleVer9.pth',
...
if __name__ == "__main__":
    ...
    model = TrackSimpleModelVer3(device=device).to(device)
    ...
    for epoch in range(args.num_epoch):
        ...
        # if 1:
            ...
            action = model(now_quad_state[:, 3:], tar_state[:, :3])
