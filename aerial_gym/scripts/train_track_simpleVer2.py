...
def get_args():
    custom_parameters = [
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": '/home/lab929/wzm/FYP/AGAPG/aerial_gym/param_saved/track_simpleVer3.pth',
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epoch):
        ...
        # if 1:
            ...
            # #     # print(action)
            # #     # print(now_state)
                print(f"    Step {step}: loss = {tmp_loss}, tar_pos = {tar_pos}, now_pos = {now_state[:, :3]}, new_pos = {new_state_dyn[:, :3]}, action = {action}")
