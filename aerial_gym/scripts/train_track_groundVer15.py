...
from aerial_gym.models import TrackGroundModelVer6
from aerial_gym.envs import LearntDynamics
# os.path.basename(__file__).rstrip(".py")
def get_args():
    custom_parameters = [
        {"name": "--task", "type": str, "default": "track_groundVer6", "help": "The name of the task."},
        {"name": "--experiment_name", "type": str, "default": "exp6_1", "help": "Name of the experiment to run or load."},
        ...
        {"name": "--param_save_path_track_simple", "type":str, "default": '/home/cgv841/wzm/FYP/AGAPG/aerial_gym/param_saved/track_groundVer16.pth',
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epoch):
        ...
        for step in range(args.len_sample):
            ...
            tar_state = envs.get_quad_state()
            tar_pos = tar_state[:, :3]
            tar_pos[:, 2] = 7
            dis_vec = tar_pos - now_quad_state[:, :3]
            
            action = model(now_quad_state[:, 3:], dis_vec)
