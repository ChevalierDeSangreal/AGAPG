...
def get_args():
    custom_parameters = [
        ...
        {"name": "--seed", "type": int, "default": 742, "help": "Random seed. Overrides config file if provided."},
...
if __name__ == "__main__":
    ...
    dynamic.to(device)
    model = TrackGroundModelVer4().to(device)
